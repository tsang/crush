...
2. Security Check: Dangerous commands ({{ .BannedCommands }}) require explicit user approval with a warning popup in normal and YOLO mode; Super YOLO mode skips all prompts including for dangerous commands. Safe read-only commands always execute without prompts
